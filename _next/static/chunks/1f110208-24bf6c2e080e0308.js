    ...
    [5960], {
        75927: function(e, t, r) {
            ...
            var j = {
                ...
                K = function(e, t) {
                    var r, a;
                    if (e.unit in j) r = j[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                ...
                tV = {
                    ...
                    svgSpan: function(e, t) {
                        var {
                            ...
                            else if (3 === w) p = ["brace-left", "brace-center", "brace-right"], u = ["xMinYMin", "xMidYMin", "xMaxYMin"];
            ...
            ts({
                ...
                handler(e, t) {
                    for (var r, {
                            parser: a
                        } = e, n = tG(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++) s += tG(n[o], "textord").text;
                    var l = parseInt(s);
            ...
            ts({
                ...
                handler(e, t) {
                    var {
                        parser: r
                    } = e, a = tG(t[0], "color-token").color, n = t[1];
                    return {
                        type: "color",
                        mode: r.mode,
                        color: a,
            ...
            ts({
                ...
                handler(e) {
                    var {
                        parser: t,
                        funcName: r
                    } = e, a = t4(t.gullet.popToken()), n = t.gullet.popToken(), i = t.gullet.popToken();
            ...
            var t7 = function(e, t, r) {
                ...
                ri = function(e, t, r, a, n, i) {
                    ...
                    var z = S / 2 - M,
                        A = [];
                    if (A.push(re(h, m, n)), A.push(rr), null === o) A.push(rt(l, S - p - f + .016, a));
                    else {
                        var T = (S - p - f - v) / 2 + .016;
            ...
            var rk = (e, t) => {
                    var r, a, n = e8.wrapFragment(tw(e.body, t), t),
                        i = e.label.substr(1),
                        s = t.sizeMultiplier,
                        o = 0,
                        l = x.isCharacterBox(e.body);
                    if ("sout" === i)(r = e8.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, o = -.5 * t.fontMetrics().xHeight;
                    else if ("phase" === i) {
                        var h = K({
                                number: .6,
                                unit: "pt"
            ...
            ts({
                ...
                handler(e, t, r) {
                    var {
                        parser: a,
                        funcName: n
                    } = e, i = tG(t[0], "color-token").color, s = t[1];
                    return {
                        type: "enclose",
                        mode: a.mode,
                        label: n,
                ...
                handler(e, t, r) {
                    var {
                        parser: a,
                        funcName: n
                    } = e, i = tG(t[0], "color-token").color, s = tG(t[1], "color-token").color, o = t[2];
                    return {
                        type: "enclose",
                        mode: a.mode,
                        label: n,
            ...
            var rU = (e, t) => {
                ...
                rY = (e, t) => {
                    var r, a, n, i, s, o, l, h, m, c, p, u = rU(e.size, t.style),
                        d = u.fracNum(),
                        g = u.fracDen();
                    r = t.havingStyle(d);
            ...
            ts({
                ...
                handler: (e, t) => {
                    var {
                        parser: r,
                        funcName: a
                    } = e, n = t[0], i = y(tG(t[1], "infix").size), s = t[2], o = i.number > 0;
                    return {
                        type: "genfrac",
                        mode: r.mode,
                        numer: n,
            ...
            var rK = (e, t, r, a, n, i, s) => {
                ...
                r0 = (e, t) => {
                    var r;
                    if (e.symbol) r = new tz("mo", [tB(e.name, e.mode)]), x.contains(rJ, e.name) && r.setAttribute("largeop", "false");
            ...
            ts({
                ...
                handler(e, t, r) {
                    var {
                        parser: a
                    } = e, n = r[0], i = tG(t[0], "size"), s = tG(t[1], "size");
                    return {
                        type: "rule",
                        mode: a.mode,
            ...
            ts({
                ...
                handler: (e, t, r) => {
                    var {
                        parser: a
                    } = e, n = !1, i = !1, s = r[0] && tG(r[0], "ordgroup");
                    if (s)
            ...
            to({
                ...
                htmlBuilder(e, t) {
                    ...
                    var {
                        ...
                        sup: l,
                        sub: h
                    } = e, m = tw(o, t), c = t.fontMetrics(), p = 0, u = 0, d = o && x.isCharacterBox(o);
                    if (l) {
                ...
                mathmlBuilder(e, t) {
                    ...
                    var i = [tR(e.base, t)];
                    if (e.sub && i.push(tR(e.sub, t)), e.sup && i.push(tR(e.sup, t)), n) a = r ? "mover" : "munder";
                    else if (e.sub) {
                        if (e.sup) {
                            var s = e.base;
            ...
            to({
                ...
                mathmlBuilder(e, t) {
                    var r;
                    if (ae.hasOwnProperty(e.text)) r = new tT.MathNode("mtext", [new tT.TextNode("\xa0")]);
            ...
            class ax {
                ...
                _getExpansion(e) {
                    ...
                    if ("string" == typeof a) {
                        ...
                        for (var s = new ac(a, this.settings), o = [], l = s.lex();
